...
public class mainProg {
	...
	public static void main(String[] args) {
    	...
    	String strFruitList[] = new String[] {"ackee","apple","apricot","atemoya","avocados",
    			...
    			"hazelnut","hog plum","honeyberries",
    			"jackfruit","jujube",
    			"kiwi",
    			"lime",
    			"mango","oranges",
        ...
        if (strFoodCategory[0].equals(category)){
        	...
        	else if (strFruitList[2].equals(inputFruit)) {//apricot
        	...
        	else if (strFruitList[3].equals(inputFruit)) {//atemoya
        	...
        	else if (strFruitList[4].equals(inputFruit)) {//avocados
        	...
        	else if (strFruitList[5].equals(inputFruit)) {//banana
        	...
        	else if (strFruitList[6].equals(inputFruit)) {//blackcurrant
        	...
        	else if (strFruitList[7].equals(inputFruit)) {//Blueberries
        	...
        	else if (strFruitList[8].equals(inputFruit)) {//Canteloupe
        	...
        	else if (strFruitList[9].equals(inputFruit)) {//Cape Gooseberries
        		System.out.println("Cape Gooseberries are low in calories and fat, yet packed with nutrients.\r\n"
        				+ "\r\n"
        	...
        	else if (strFruitList[10].equals(inputFruit)) {//chempedak
        	...
        	else if (strFruitList[11].equals(inputFruit)) {//cherry
        	...
        	else if (strFruitList[12].equals(inputFruit)) {//coconut
        	...
        	else if (strFruitList[13].equals(inputFruit)) {//Cranberries
        	...
        	else if (strFruitList[14].equals(inputFruit)) {//custard apple
        	...
        	else if (strFruitList[15].equals(inputFruit)) {//dates
        	...
        	else if (strFruitList[16].equals(inputFruit)) {//dragon fruit
        	...
        	else if (strFruitList[17].equals(inputFruit)) {//eggfruit
        	...
        	else if (strFruitList[18].equals(inputFruit)) {//fig
        	...
        	else if (strFruitList[19].equals(inputFruit)) {//fuyu
        	...
        	else if (strFruitList[20].equals(inputFruit)) {//gooseberries
        	...
        	else if (strFruitList[21].equals(inputFruit)) {//grapes
        	...
        	else if (strFruitList[22].equals(inputFruit)) {//guava
        	...
        	else if (strFruitList[23].equals(inputFruit)) {//hazelnuts
        	...
        	else if (strFruitList[24].equals(inputFruit)) {// hog plum
        	...
        	else if (strFruitList[25].equals(inputFruit)) {//honeydew
